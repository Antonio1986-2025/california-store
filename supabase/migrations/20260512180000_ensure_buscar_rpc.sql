...
drop function if exists public.buscar_produtos(text);
create function public.buscar_produtos(termo text)
returns table (
  variante_id uuid,
  produto_id uuid,
  nome text,
...
drop function if exists public.buscar_clientes(text);
create function public.buscar_clientes(termo text)
returns table (
  id uuid,
  nome text,
  cpf text,
